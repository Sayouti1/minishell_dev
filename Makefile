...
SRCS= srcs/main.c srcs/test_utils.c \
	srcs/execution/builtin/cd.c srcs/execution/builtin/env.c srcs/execution/builtin/env_2.c srcs/execution/builtin/pwd.c srcs/execution/builtin/export.c \
	...
	srcs/execution/utils/utils.c srcs/execution/utils/utils_2.c srcs/execution/utils/pipe_exec.c srcs/execution/utils/signal.c \
	srcs/execution/utils/heredoc.c srcs/execution/utils/length.c srcs/execution/utils/str_utils.c
