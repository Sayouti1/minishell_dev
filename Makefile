...
SRCS= srcs/main.c \
	...
	srcs/execution/builtin/exit.c srcs/execution/builtin/unset.c srcs/execution/builtin/echo.c srcs/execution/builtin/exec_builtin.c srcs/execution/builtin/command_handler.c \
