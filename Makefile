...
SRCS= srcs/main.c \
	...
	srcs/execution/utils/token_to_command.c srcs/execution/utils/token_to_command_2.c \
	srcs/execution/utils/parse_line.c srcs/execution/utils/getters.c srcs/execution/utils/setters.c srcs/execution/utils/split.c \
